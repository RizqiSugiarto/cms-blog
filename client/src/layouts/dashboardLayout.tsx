...
const DashboardLayout: React.FC = () => {
    const getNavLinkClass = ({ isActive }: { isActive: boolean }) =>
        isActive ? "text-lg btn btn-primary justify-start w-full" : "text-lg btn btn-ghost justify-start w-full";
        ...
        <main className="drawer lg:drawer-open">
            ...
            <div className="drawer-side z-30">
                ...
                <ul className="menu p-4 w-64 md:w-80 min-h-full bg-base-100 text-base-content space-y-2 [&>a]:btn-primary">
                    <div>
                        <h2 className="text-xl font-bold btn btn-ghost justify-start w-full">SIMPLE CMS</h2>
                    </div>
                    <li>
                    ...
                    <li>
                        <NavLink to="/dashboard/addblog" end className={getNavLinkClass}>
                    ...
                    <li>
                    <NavLink to="/" className="text-lg btn btn-ghost justify-start w-full">
